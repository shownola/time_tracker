...
describe 'navigate' do
  ...
  describe 'new' do
    it 'has a link from the homepage' do
      employee = Employee.create(first_name: 'Employee', last_name: 'Doe', email: "employee@example.com", password: "asdfasdf",
  ...
  describe 'delete' do
    it 'can be deleted' do
     ...
     post_to_delete = Post.create(date: Date.today, rationale: "Anything", user_id: delete_user.id, overtime_request: 3.5)
      visit posts_path
